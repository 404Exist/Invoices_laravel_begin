    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/invoices-search" method="POST" role="search" autocomplete="off">
                    @csrf

                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="searchType" type="radio" value="1" id="type_div">
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox">
                            <input name="searchType" value="2" type="radio">
                    ...
                    <div class="row">
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            ...
                            <select class="form-control select2" name="invoiceStatus" required>
                                <option value="{{ $status ?? 'حدد نوع الفواتير' }}" selected>
                                    {{ $status ?? 'حدد نوع الفواتير' }}
                                </option>
                            ...
                            <tbody>
                                ...
                                @foreach ($details as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/invoices/details/{{ $invoice->id }}">{{ $invoice->section->section_name }}</a>
                                        </td>
