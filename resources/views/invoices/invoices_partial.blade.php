                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            ...
                            <tbody>
                                ...
                                $i = 0;
                                @endphp
                                @foreach ($patialPaidInvoices as $invoice)
                                    @php
                                    $i++
                                    @endphp
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item" href="/invoice-edit/{{ $invoice->id }}"> تعديل الفاتورة </a>
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('invoice-status', [$invoice->id]) }}">
