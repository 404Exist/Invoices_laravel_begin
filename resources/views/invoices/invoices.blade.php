        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a class="modal-effect btn btn-primary" href="/invoices-export"
                            ...
                            <tbody>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/invoices/details/{{ $invoice->id }}">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item"
                                                        href="/invoice-edit/{{ $invoice->id }}">تعديل الفاتورة</a>
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('invoice-status', [$invoice->id]) }}">
                                                        <i class="text-success fas fa-money-bill"></i>&nbsp;&nbsp;حالة الدفع</a>
                                                    ...
                                                    <a class="dropdown-item" href="/invoice-print/{{ $invoice->id }}"><i
        ...
        <div class="modal fade" id="delete_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('invoices.destroy', 'must-send-invoice-when-destory-but-i-send-id-in-request-before') }}" method="post">
                        @csrf
                        @method('delete')
