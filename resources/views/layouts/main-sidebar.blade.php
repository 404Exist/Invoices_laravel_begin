			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
							<h4 class="font-weight-semibold mt-3 mb-0">{{ ucwords(auth()->user()->name) }}</h4>
				...
				<ul class="side-menu">
                    ...
                    @can('الفواتير')
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                @endcan
                                @can('الفواتير المدفوعة')
                                    <li><a class="slide-item" href="{{ url('/' . $page='partial-invoices') }}">الفواتير المدفوعة جزئيا</a></li>
                                @endcan
                                @can('ارشيف الفواتير')
                                    <li><a class="slide-item" href="{{ url('/' . $page='archived-invoices') }}"> أرشيف الفواتير</a></li>
                                @endcan
                            </ul>
                        </li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">تقارير المستخدمين</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">قائمة المسخدمين</a></li>
